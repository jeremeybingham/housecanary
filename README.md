...
It's running in Docker on a t3a.medium ec2 instance with NGINX and Gunicorn to manage networking, with the instance DNS pointed at https://housecanary/mandard.net. 
